...
..\Compiler\Ahk2Exe.exe /in ..\AHK\SteamBulkKeyActivator.ahk /out ..\Builds\SteamBulkKeyActivator_x64.exe /bin "..\Compiler\Unicode 64-bit.bin" /mpress 1
Echo "Compiled x64 version [OK]"


Echo "Compiling x86 version ..."
..\Compiler\Ahk2Exe.exe /in ..\AHK\SteamBulkKeyActivator.ahk /out ..\Builds\SteamBulkKeyActivator_x86.exe /bin "..\Compiler\Unicode 32-bit.bin" /mpress 1
